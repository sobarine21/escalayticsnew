...
def get_sentiment(text):
    positive_words = ["happy", "good", "great", "excellent", "love", "satisfied"]
    negative_words = ["sad", "bad", "hate", "angry", "disappointed", "frustrated"]
...
def detect_root_cause(text):
    if "delay" in text.lower():
        return "Root Cause: Project delays due to miscommunication."
    elif "error" in text.lower():
        return "Root Cause: Possible technical error in process."
    return "Root Cause: Lack of clear communication."
